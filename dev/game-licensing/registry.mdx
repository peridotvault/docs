...
Registers a new game in Registry.
...
- `gameId` MUST match `PGC1(contractAddress).getGameId()`
...
- `msg.sender` MUST match `PGC-1.getPublisher()` during registration
